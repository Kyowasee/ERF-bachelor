...
#                                                                              #
################################################################################ 
#THIS IS COMBINED-1 AND COMBINED-2 (random) RESULTS WITH EBNER RULES
################################################################################ 
...
# Diabetes UCI Data 
data <- read.csv(file = './data sets/combined-1.csv', header = T)
#data <- read.csv(file = './data sets/combined-2.csv', header = T) #random 
...
erf_vec_2000 <- unlist(erf_2000, use.names=FALSE)
...
erf_prio_vec_2000 <- unlist(erf_prio_2000, use.names=FALSE)
...
erf_only_vec_2000 <- unlist(erf_only_2000, use.names=FALSE)
...
rf_vec_2000 <- unlist(rf_2000, use.names=FALSE)
...
comparison_df <- data.frame(NTerms = NTerms, AvgRuleLength = AvgRuleLength,
                            ...
                            Sample = rep(c("full (2768)", "2000", "1000", "500"),4))
...
p1 <- ggplot(comparison_df, 
  ...
  scale_x_discrete(limits=c("full (2768)","2000","1000", "500")) +
