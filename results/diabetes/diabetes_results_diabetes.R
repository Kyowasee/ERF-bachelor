...
#                                                                              #
################################################################################ 
#THIS IS DIABETES RESULTS WITH YOWASEE RULES
################################################################################ 
...
#set.seed(2394)
#data_600 <- sample_n(data, 2000)
#data_400 <- sample_n(data, 1000)
#data_200 <- sample_n(data, 500)
...
#erf_2000 <- CV_erf(data = data_2000, confirmatory_expert_rules = conf_rules, 
#optional_expert_rules = opt_rules, 
#confirmatory_linear_terms = conf_linear,
#optional_linear_terms = opt_linear)
...
# create dataframe to plot 
#erf_vec_200 <- unlist(erf_500, use.names=FALSE)
#erf_vec_400 <- unlist(erf_100, use.names=FALSE)
#erf_vec_600 <- unlist(erf_2000, use.names=FALSE)
#erf_vec_full <- unlist(erf_full, use.names=FALSE)

erf_performance <- data.frame(erf_full = erf_vec_full, erf_600 = erf_vec_600, 
                              erf_400 = erf_vec_400, erf_200 = erf_vec_200)

#erf_performance <- data.frame(erf_full = erf_vec_full, erf_2000 = erf_vec_2000, 
...
#erf_prio_2000 <- CV_erf(data = data_2000, confirmatory_expert_rules = conf_rules, 
#optional_expert_rules = opt_rules, 
#confirmatory_linear_terms = conf_linear,
#optional_linear_terms = opt_linear,
#optional_penalty = 0.5)
...
#erf_prio_vec_200 <- unlist(erf_prio_500, use.names=FALSE)
#erf_prio_vec_400 <- unlist(erf_prio_1000, use.names=FALSE)
#erf_prio_vec_600 <- unlist(erf_prio_2000, use.names=FALSE)
#erf_prio_vec_full <- unlist(erf_prio_full, use.names=FALSE)
...
#erf_prio_performance <- data.frame(erf_prio_full = erf_prio_vec_full, 
#erf_prio_2000 = erf_prio_vec_2000, 
...
#erf_only_2000 <- CV_erf(data = data_2000, confirmatory_expert_rules = conf_rules,
#optional_expert_rules = opt_rules, 
#optional_linear_terms = opt_linear,
#confirmatory_linear_terms = conf_linear, expert_only = T)
...
#erf_only_vec_200 <- unlist(erf_only_500, use.names=FALSE)
#erf_only_vec_400 <- unlist(erf_only_1000, use.names=FALSE)
#erf_only_vec_600 <- unlist(erf_only_2000, use.names=FALSE)
#erf_only_vec_full <- unlist(erf_only_full, use.names=FALSE)
...
#erf_only_performance <- data.frame(erf_only_full = erf_only_vec_full,
#erf_only_2000 = erf_only_vec_2000, 
...
#rf_vec_200 <- unlist(rf_500, use.names=FALSE)
#rf_vec_400 <- unlist(rf_1000, use.names=FALSE)
#rf_vec_600 <- unlist(rf_2000, use.names=FALSE)
#rf_vec_full <- unlist(rf_full, use.names=FALSE)

rf_performance <- data.frame(rf_full = rf_vec_full, rf_600 = rf_vec_600,
                             rf_400 = rf_vec_400, rf_200 = rf_vec_200)

#rf_performance <- data.frame(rf_full = rf_vec_full, rf_2000 = rf_vec_2000,
...
comparison_df <- data.frame(NTerms = NTerms, AvgRuleLength = AvgRuleLength,
                            ...
                            Sample = rep(c("full (768)", "600", "400", "200"),4))
...
p2
pdf("Avgrulelength_de_diabetes4.pdf")
p2
dev.off()
...
p5
pdf("PropEKImp_de_diabetes4.pdf")
p5
dev.off()
