...
#                                                                              #
################################################################################ 
#THIS IS DIABETES-4 RESULTS WITH YOWAASEE RULES 
################################################################################ 
...
# Diabetes UCI Data 
data <- read.csv(file = './data sets/diabetes-4.csv', header = T)
...
p1 <- ggplot(comparison_df, 
  ...
  scale_x_discrete(limits=c("full (2000)", "1500", "1000", "500")) +
...
p2
pdf("Avgrulelength_de_diabetes5.pdf")
p2
dev.off()
...
p5
pdf("PropEKImp_de_diabetes5.pdf")
p5
dev.off()
